...
namespace TangyRestaurantWebsite.Controllers
{
    public class OrderController : Controller
    {
        ...
        public IActionResult OrderPickupDetails(int orderId)
        {
            ...
            OrderDetailsVM.OrderDetail = _db.OrderDetail.Where(o => o.OrderId == OrderDetailsVM.OrderHeader.Id).ToList();
        ...
        public IActionResult OrderSummaryExport(OrderExportViewModel orderExportVM)
        {
            ...
            {
                IndividualOrderList = _db.OrderDetail.Where(o => o.OrderId == OrderHeader.Id).ToList();
